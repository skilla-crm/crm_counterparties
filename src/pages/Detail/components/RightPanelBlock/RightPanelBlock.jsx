        ...
        <div className={s.rightPanelBlock}>
            ...
            {title === 'Документы' && (
                <div className={s.links}>
                    <Link
                        className={s.link}
                        to={`https://lk.skilla.ru/new/bills?counterpartyId=${counterpartyId}`}
                    >
                        <IconArrowRight />
                        Все счета
                    </Link>
                    <Link
                        className={s.link}
                        to={`https://lk.skilla.ru/new/upd?counterpartyId=${counterpartyId}`}
                    >
                        <IconArrowRight />
                        Все упд
                    </Link>
                    <Link
                        className={s.link}
                        to={`https://lk.skilla.ru/new/act?counterpartyId=${counterpartyId}`}
                    >
                        <IconArrowRight />
                        Все акты
                    </Link>
            ...
            {title === 'Заказы' && (
                <div className={s.links}>
                    <Link
                        className={s.link}
                        to={`https://lk.skilla.ru/new/orders?counterpartyId=${counterpartyId}`}
                    >
                        <IconArrowRight />
                        Посмотреть все
                    </Link>
            ...
            {title === 'Транзакции' && (
                <div className={s.links}>
                    <Link
                        className={s.link}
                        to={`https://lk.skilla.ru/new/bank?counterpartyId=${counterpartyId}`}
                    >
                        <IconArrowRight />
                        Посмотреть все
                    </Link>
