    ...
    <div ref={modalRef} className={s.root}>
      ...
      <div
        className={classNames(
          s.container,
          containerStaus === 1 && s.container_1,
          containerStaus === 2 && s.container_2,
          (containerStaus === 3 || containerStaus === 4) && s.container_3
        )}
      >
...
const BlockSend = ({ handleClose, id }) => {
  ...
  const handleSendOriginal = () => {
    ...
    console.log("id", id);
    sendOriginalContract({ body: dataForSend, id })
      .then((res) => {
        console.log(" res", res);
...
const BlockSign = ({ handleClose, id }) => {
  ...
  const handleSignOriginal = () => {
    ...
    signOriginalContract({ body: dataForSend, id }).then((res) => {
      res.data.success && handleClose();
    });
  };
...
const BlockReject = ({ handleClose, type, id }) => {
  ...
  const handleUnmark = (e) => {
    ...
    unmarkOriginalContract({ body: { type: idType }, id }).then((res) => {
      res.data.success && handleClose();
    });
  };
  return (
