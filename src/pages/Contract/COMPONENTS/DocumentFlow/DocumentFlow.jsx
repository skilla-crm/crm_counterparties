        ...
        <div ref={modalRef} className={s.root}>
            <div className={s.block}>
                ...
                >
                    ...
                    {exchange?.send !== 1 && (
                        <p>Подтвердить отправку оригиналов</p>
                    )}
                    {exchange?.send === 1 &&
                        exchange?.send_type === 'self_pickup' && (
                            <p>Бумажный оригинал передан</p>
                        )}
                    {exchange?.send === 1 &&
                        exchange?.send_type === 'courier' && (
            ...
            <div
                className={classNames(
                    ...
                    (containerStatus === 3 || containerStatus === 4) &&
                        s.container_3
                )}
            >
                {blockStatus === 1 && (
                    <BlockSend handleClose={handleClose} id={id} />
                )}
                {blockStatus === 2 && (
                    <BlockSign handleClose={handleClose} id={id} />
                )}
                {blockStatus === 3 && (
                    <BlockReject
    ...
    return (
        <div className={classNames(s.block, s.block_inner)}>
            ...
            <button onClick={handleSendOriginal} className={s.button}>
                <div
                    className={classNames(s.loader, isLoading && s.loader_vis)}
                >
