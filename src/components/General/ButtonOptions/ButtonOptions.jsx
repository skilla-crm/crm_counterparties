    ...
    return (
        <div className={s.root}>
            ...
            <button
                ...
                className={classNames(s.button, s.button_options)}
            >
                <IconChewron
                    className={classNames(s.arrow, openOptions && s.arrow_open)}
                />
            </button>

            <ul
                ref={optionsRef}
                className={classNames(s.options, openOptions && s.options_open)}
            >
                {options?.map((el) => {
